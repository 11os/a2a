  ...
  ;(r = {
      ...
      function (t, i, n) {
        ...
        ((i.exports = r).prototype.on = function (t, i, n) {
          ...
          (r.prototype.off = function (t, i) {
            ...
            else for (var n = this.i[t], r = 0; r < n.length; ) n[r].fn === i ? n.splice(r, 1) : ++r
            return this
          }),
        ...
        function r(t) {
          ...
          function l(t, i, n, r, e, s) {
            ...
            0 === (r = u ? -r : r)
              ...
              ? (t((o = r / 5e-324) >>> 0, e, s + i), t(((u << 31) | (o / 4294967296)) >>> 0, e, s + n))
              : (t(
                  (4503599627370496 *
                    (o = r * Math.pow(2, -(r = 1024 === (r = Math.floor(Math.log(r) / Math.LN2)) ? 1023 : r)))) >>>
                    0,
                  e,
                  s + i
                ),
          ...
          (n.read = function (t, i, n) {
            ...
            for (var r, e = null, s = [], o = 0; i < n; )
              (r = t[i++]) < 128
                ...
                ? (s[o++] = ((31 & r) << 6) | (63 & t[i++]))
                : 239 < r && r < 365
                ? ((r = (((7 & r) << 18) | ((63 & t[i++]) << 12) | ((63 & t[i++]) << 6) | (63 & t[i++])) - 65536),
                  (s[o++] = 55296 + (r >> 10)),
                  (s[o++] = 56320 + (1023 & r)))
    ...
    11: [
      function (t, i, n) {
        ...
        e('any', { Any: { fields: { type_url: { type: 'string', id: 1 }, value: { type: 'bytes', id: 2 } } } }),
          e('duration', {
          ...
          e('struct', {
            ...
            Value: {
              oneofs: {
                kind: { oneof: ['nullValue', 'numberValue', 'stringValue', 'boolValue', 'structValue', 'listValue'] }
              },
              fields: {
          ...
          e('field_mask', { FieldMask: { fields: { paths: { rule: 'repeated', type: 'string', id: 1 } } } }),
          (e.get = function (t) {
            return e[t] || null
          })
      },
      ...
      function (t, i, n) {
        ...
        function o(t, i, n, r) {
          if (i.resolvedType)
            if (i.resolvedType instanceof l) {
              ...
              t('if(typeof d%s!=="object")', r)('throw TypeError(%j)', i.fullName + ': object expected')(
        ...
        (n.fromObject = function (t) {
          ...
          for (var r = 0; r < i.length; ++r) {
            ...
            e.map
              ? (n('if(d%s){', s)('if(typeof d%s!=="object")', s)(
                ...
                o(n, e, r, s + '[ks[i]]')('}')('}'))
              : e.repeated
              ? (n('if(d%s){', s)('if(!Array.isArray(d%s))', s)('throw TypeError(%j)', e.fullName + ': array expected')(
                  'm%s=[]',
                  s
                )('for(var i=0;i<d%s.length;++i){', s),
                o(n, e, r, s + '[i]')('}')('}'))
          ...
          (n.toObject = function (t) {
            ...
            if (r.length) {
              for (n('if(o.arrays||o.defaults){'), o = 0; o < r.length; ++o) n('d%s=[]', v.safeProp(r[o].name))
              n('}')
            }
            if (e.length) {
              for (n('if(o.objects||o.defaults){'), o = 0; o < e.length; ++o) n('d%s={}', v.safeProp(e[o].name))
              n('}')
            }
            if (s.length) {
              for (n('if(o.defaults){'), o = 0; o < s.length; ++o) {
                ...
                f.resolvedType instanceof l
                  ? n('d%s=o.enums===String?%j:%j', h, f.resolvedType.valuesById[f.typeDefault], f.typeDefault)
                  : f.long
                  ? n('if(util.Long){')(
                      ...
                      h
                    )('}else')('d%s=o.longs===String?%j:%i', h, f.typeDefault.toString(), f.typeDefault.toNumber())
                  : f.bytes
                  ? ((u = '[' + Array.prototype.slice.call(f.typeDefault).join(',') + ']'),
                    n('if(o.bytes===String)d%s=%j', h, String.fromCharCode.apply(String, f.typeDefault))('else{')(
                      'd%s=%s',
                      h,
                      u
                    )(
            ...
            for (var a = !1, o = 0; o < i.length; ++o) {
              ...
              f.map
                ? (a || ((a = !0), n('var ks2')),
                  ...
                  d(n, f, c, h + '[ks2[j]]')('}'))
                : f.repeated
                ? (n('if(m%s&&m%s.length){', h, h)('d%s=[]', h)('for(var j=0;j<m%s.length;++j){', h),
                  d(n, f, c, h + '[j]')('}'))
    ...
    13: [
      function (t, i, n) {
        i.exports = function (t) {
          var i = h.codegen(['r', 'l'], t.name + '$decode')('if(!(r instanceof Reader))')('r=Reader.create(r)')(
            ...
            i('case %i:', r.id),
              r.map
                ? (i('if(%s===util.emptyObject)', s)('%s={}', s)('var c2 = r.uint32()+r.pos'),
                  ...
                  f.basic[e] === Q ? i('value=types[%i].decode(r,r.uint32())', n) : i('value=r.%s()', e),
                ...
                ? (i('if(!(%s&&%s.length))', s, s)('%s=[]', s),
                  f.packed[e] !== Q &&
                    i('if((t&7)===2){')('var c2=r.uint32()+r.pos')('while(r.pos<c2)')('%s.push(r.%s())', s, e)('}else'),
                  f.basic[e] === Q
                    ? i(
                    ...
                    : i('%s.push(r.%s())', s, e))
                : f.basic[e] === Q
                ? i(r.resolvedType.group ? '%s=types[%i].decode(r)' : '%s=types[%i].decode(r,r.uint32())', s, n)
                : i('%s=r.%s()', s, e),
              i('break')
          }
      ...
      function (t, i, n) {
                ...
                ? (n('if(%s!=null&&%s.length){', i, i),
                  s.packed && a.packed[u] !== Q
                    ...
                    : (n('for(var i=0;i<%s.length;++i)', i),
                      f === Q ? l(n, s, o, i + '[i]') : n('w.uint32(%i).%s(%s[i])', ((s.id << 3) | f) >>> 0, u, i)),
                  n('}'))
                : (s.optional && n('if(%s!=null&&Object.hasOwnProperty.call(m,%j))', i, s.name),
                  f === Q ? l(n, s, o, i) : n('w.uint32(%i).%s(%s)', ((s.id << 3) | f) >>> 0, u, i))
          }
          return n('return w')
        }
        var h = t(15),
        ...
        function l(t, i, n, r) {
          return i.resolvedType.group
            ? t('types[%i].encode(%s,w.uint32(%i)).uint32(%i)', n, r, ((i.id << 3) | 3) >>> 0, ((i.id << 3) | 4) >>> 0)
    ...
    16: [
      function (t, i, n) {
        ...
        function o(t, i, n, r, e, s, o) {
          if (
            (h.isObject(r) ? ((o = e), (s = r), (r = e = Q)) : h.isObject(e) && ((o = s), (s = e), (e = Q)),
            u.call(this, t, s),
            !h.isInteger(i) || i < 0)
          )
            throw TypeError('id must be a non-negative integer')
          if (!h.isString(n)) throw TypeError('type must be a string')
          if (r !== Q && !a.test((r = r.toString().toLowerCase()))) throw TypeError('rule must be a string rule')
          ...
          (o.prototype.resolve = function () {
            return this.resolved
              ...
              : ((this.typeDefault = f.defaults[this.type]) === Q &&
                  ((this.resolvedType = (this.declaringField || this).parent.lookupTypeOrEnum(this.type)),
                ...
                this.options &&
                  ((!0 !== this.options.packed &&
                    (this.options.packed === Q || !this.resolvedType || this.resolvedType instanceof e)) ||
                    delete this.options.packed,
                  Object.keys(this.options).length || (this.options = Q)),
                this.long
                  ? ((this.typeDefault = h.Long.fromNumber(this.typeDefault, 'u' == (this.type[0] || ''))),
                    Object.freeze && Object.freeze(this.typeDefault))
                  : this.bytes &&
                    'string' == typeof this.typeDefault &&
                    (h.base64.test(this.typeDefault)
                      ? h.base64.decode(this.typeDefault, (t = h.newBuffer(h.base64.length(this.typeDefault))), 0)
                      : h.utf8.write(this.typeDefault, (t = h.newBuffer(h.utf8.length(this.typeDefault))), 0),
                    (this.typeDefault = t)),
                this.map
    ...
    20: [
      function (t, i, n) {
        ...
        function s(t, i, n, r, e, s) {
          if ((o.call(this, t, i, r, Q, Q, e, s), !u.isString(n))) throw TypeError('keyType must be a string')
    ...
    22: [
      function (t, i, n) {
        ...
        function r(t, i, n, r, e, s, o, u, f) {
          if ((a.isObject(e) ? ((o = e), (e = s = Q)) : a.isObject(s) && ((o = s), (s = Q)), i !== Q && !a.isString(i)))
      ...
      function (t, i, n) {
        ...
        (a.fromJSON = function (t, i) {
          ...
          (a.isReservedId = function (t, i) {
            if (t)
              for (var n = 0; n < t.length; ++n) if ('string' != typeof t[n] && t[n][0] <= i && t[n][1] > i) return !0
            return !1
          }),
          ...
          (a.prototype.addJSON = function (t) {
            if (t)
              for (var i, n = Object.keys(t), r = 0; r < n.length; ++r)
                (i = t[n[r]]),
                  this.add(
                    (i.fields !== Q ? e : i.values !== Q ? o : i.methods !== Q ? s : i.id !== Q ? u : a).fromJSON(
                      n[r],
                      i
                    )
                  )
      ...
      function (t, i, n) {
        ...
        Object.defineProperties(e.prototype, {
          ...
          (e.prototype.setOption = function (t, i, n) {
            return (n && this.options && this.options[t] !== Q) || ((this.options || (this.options = {}))[t] = i), this
          }),
    ...
    25: [
      function (t, i, n) {
        ...
        var r = t(16),
          s = t(37)
        function o(t, i, n, r) {
          if ((Array.isArray(i) || ((n = i), (i = Q)), e.call(this, t, n), i !== Q && !Array.isArray(i)))
        ...
        (o.fromJSON = function (t, i) {
          ...
          (o.prototype.toJSON = function (t) {
            t = !!t && !!t.keepComments
            return s.toObject(['options', this.options, 'oneof', this.oneof, 'comment', t ? this.comment : Q])
          }),
      ...
      function (t, i, n) {
        ...
        function K(t, i, n) {
          ...
          function m(t, i, n) {
            ...
            return (
              n || (K.filename = null),
              Error('illegal ' + (i || 'token') + " '" + t + "' (" + (r ? r + ', ' : '') + 'line ' + h.line + ')')
            )
          }
          function g() {
            var t,
          ...
          function k(t, i) {
            for (
              var n;
              !i || ('"' !== (n = l()) && "'" !== n) ? t.push([(n = O(a())), v('to', !0) ? O(a()) : n]) : t.push(g()),
                v(',', !0);
          ...
          function A(t, i, n) {
            var r,
              e = h.line
            if ((t && ('string' != typeof t.comment && (t.comment = d()), (t.filename = K.filename)), v('{', !0))) {
              for (; '}' !== (r = a()); ) i(r)
              v(';', !0)
            } else n && n(), v(';'), t && ('string' != typeof t.comment || u) && (t.comment = d(e) || t.comment)
          }
          function x(t, i, n) {
            var r = a()
            if ('group' !== r) {
              ...
              A(
                ...
                'proto3_optional' === i
                  ...
                  : t.add(s),
                b || !s.repeated || (R.packed[r] === Q && R.basic[r] !== Q) || s.setOption('packed', !1, !0)
            } else
              !(function (t, i) {
                var n = a()
          ...
          function T(t, i) {
            ...
            var r = i,
              e = r
            n && (v(')'), (e = r = '(' + r + ')'), (i = l()), G.test(i) && ((s = i.substr(1)), (r += i), a())), v('=')
            var s,
              r = (function t(i, n) {
                if (v('{', !0)) {
                  for (var r = {}; !v('}', !0); ) {
          ...
          for (; null !== (f = a()); )
            switch (f) {
              ...
              case 'syntax':
                if (!p) throw m(f)
                !(function () {
                  if ((v('='), (o = g()), !(b = 'proto3' === o) && 'proto2' !== o)) throw m(o, 'syntax')
                  v(';')
                })()
                break
              case 'option':
          ...
          return (K.filename = null), { package: r, imports: e, weakImports: s, syntax: o, root: i }
        }
      },
    ...
    29: [
      function (t, i, n) {
        ...
        (f.prototype.h = function (t) {
          if (t instanceof s) t.extend === Q || t.extensionField || a(0, t) || this.deferred.push(t)
    ...
    32: [
      function (t, i, n) {
        ...
        (((r.prototype = Object.create(u.EventEmitter.prototype)).constructor = r).prototype.rpcCall = function t(
          n,
          i,
          r,
          e,
          ...
          (r.prototype.end = function (t) {
            return (
              this.rpcImpl && (t || this.rpcImpl(null, null, null), (this.rpcImpl = null), this.emit('end').off()), this
            )
          })
      },
      { 39: 39 }
      ...
      function (t, i, n) {
        ...
        function s(f, h) {
          ...
          function j(t, i, n) {
            ...
            for (var s = f.substring(t, i).split(V), o = 0; o < s.length; ++o) s[o] = s[o].replace(h ? N : S, '').trim()
            v = s.join('\n').trim()
          }
          function k(t) {
            var i = O(t),
        ...
        Object.defineProperties(m.prototype, {
          ...
          (m.generateConstructor = function (t) {
            for (var i, n = v.codegen(['p'], t.name), r = 0; r < t.fieldsArray.length; ++r)
              (i = t.e[r]).map ? n('this%s={}', v.safeProp(i.name)) : i.repeated && n('this%s=[]', v.safeProp(i.name))
          ...
          (m.fromJSON = function (t, i) {
            ...
            if (i.nested)
              for (r = Object.keys(i.nested), e = 0; e < r.length; ++e) {
                var s = i.nested[r[e]]
                n.add(
                  (s.id !== Q ? h : s.fields !== Q ? m : s.values !== Q ? u : s.methods !== Q ? c : o).fromJSON(r[e], s)
                )
              }
            return (
          ...
          (m.prototype.add = function (t) {
            ...
            if (t instanceof h && t.extend === Q) {
              if ((this.v || this.fieldsById)[t.id]) throw Error('duplicate id ' + t.id + ' in ' + this)
        ...
        ;(s.decorateEnum = function (t) {
          ...
          (s.setProperty = function (t, i, n) {
            ...
            return (function t(i, n, r) {
              var e = n.shift()
              return (
                0 < n.length ? (i[e] = t(i[e] || {}, n, r)) : ((n = i[e]) && (r = [].concat(n).concat(r)), (i[e] = r)),
                i
              )
            })(t, (i = i.split('.')), n)
          }),
      ...
      function (t, i, n) {
        ...
        ;(e.fromNumber = function (t) {
          ...
          var i = t < 0,
            ...
            t = ((t - n) / 4294967296) >>> 0
          return (
            i && ((t = ~t >>> 0), (n = ~n >>> 0), 4294967295 < ++n && ((n = 0), 4294967295 < ++t && (t = 0))),
            new e(n, t)
          )
        }),
          (e.from = function (t) {
        ...
        ;(e.fromHash = function (t) {
          return '\0\0\0\0\0\0\0\0' === t
            ? s
            : new e(
                (o.call(t, 0) | (o.call(t, 1) << 8) | (o.call(t, 2) << 16) | (o.call(t, 3) << 24)) >>> 0,
                (o.call(t, 4) | (o.call(t, 5) << 8) | (o.call(t, 6) << 16) | (o.call(t, 7) << 24)) >>> 0
              )
        }),
    ...
    39: [
      function (t, i, n) {
        var r = n
        function e(t, i, n) {
          for (var r = Object.keys(i), e = 0; e < r.length; ++e) (t[r[e]] !== Q && n) || (t[r[e]] = i[r[e]])
          return t
        }
        function s(t) {
          function n(t, i) {
        ...
        i.exports = function (t) {
          ...
          for (var e = 0; e < t.fieldsArray.length; ++e) {
            ...
            o.optional && i('if(%s!=null&&m.hasOwnProperty(%j)){', u, o.name),
              o.map
                ? (i('if(!util.isObject(%s))', u)('return%j', h(o, 'object'))('var k=Object.keys(%s)', u)(
                  ...
                  a(i, o, e, u + '[k[i]]')('}'))
                : o.repeated
                ? (i('if(!Array.isArray(%s))', u)('return%j', h(o, 'array'))('for(var i=0;i<%s.length;++i){', u),
                  a(i, o, e, u + '[i]')('}'))
                : (o.partOf &&
          ...
          (c.prototype.uint32 = function (t) {
            return (
              (this.len += (this.tail = this.tail.next =
                new d((t >>>= 0) < 128 ? 1 : t < 16384 ? 2 : t < 2097152 ? 3 : t < 268435456 ? 4 : 5, t)).len),
              this
            )
          }),
    ...
    43: [
      function (t, i, n) {
        ...
        (s.u = function () {
          (s.alloc = e.y),
            (s.writeBytesBuffer =
              e.Buffer && e.Buffer.prototype instanceof Uint8Array && 'set' === e.Buffer.prototype.set.name
                ? function (t, i, n) {
                    i.set(t, n)
                  }
                : function (t, i, n) {
